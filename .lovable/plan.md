...
- [ ] عند تغيير حالة مهمة في Kanban، تظهر التغييرات فوراً في لوحة التحكم
- [ ] إحصائيات المهام (مكتملة/قيد التنفيذ/متأخرة) صحيحة 100%
- [ ] إمكانية نسخ (Clone) المهمة مثل Jira
- [ ] وجود عمود "معلقة" (Blocked) في Kanban
- [ ] تسجيل الدخول أسرع بدون تأخير ملحوظ
- [ ] تصدير واستيراد المهام متوافق تماماً (نفس الأعمدة)
- [ ] لا يوجد تكرار عند استيراد ملف مُصدّر سابقاً
